...
export default function AutoComplete(props) {
  const { optionList, instructionText, selectedValue, testId, helperText, errorText, fieldId } = props;
  ...
  return (
    <FormGroup {...props}>
      ...
      {arrOptions && arrOptions.length > 0 ? (
        <select className={inputClasses} id={fieldId} name={fieldId} value={getDefaultValue()} data-test-id={testId}>
