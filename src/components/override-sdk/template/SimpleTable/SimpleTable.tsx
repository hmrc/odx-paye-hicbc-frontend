  ...
  if (multiRecordDisplayAs === 'fieldGroup') {
    ...
    return (
      <div style={{ overflowX: 'auto' }}>
        <ConditionalWrapper
          condition={configAlternateDesignSystem?.IsSummaryList}
          childrenToWrap={<FieldGroupTemplate {...fieldGroupProps} />}
          wrapper={childrenToWrap => {
            return <dl className='govuk-summary-list'>{childrenToWrap}</dl>;
          }}
        />
      </div>
    );
