...
export default function Details(props) {
  ...
  return (
    ...
    <ConditionalWrapper
      condition={
        !PCore.getStore().getState().data[containerName].caseInfo?.status.startsWith('Open') && !Object.getOwnPropertyNames(inheritedConfig).length
      }
      wrapper={childrenForWrap => <MainWrapper showPageNotWorkingLink={false}>{childrenForWrap}</MainWrapper>}
      childrenToWrap={
        <>
