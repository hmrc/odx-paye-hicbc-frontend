...
export default function CheckboxComponent(props) {
  const { getPConnect, inputProps, validatemessage, readOnly, value, configAlternateDesignSystem, helperText, placeholder } = props;
  ...
  const fieldId = getPConnect().viewName.toLowerCase() === 'declaration' ? `${formattedPropertyName}` : `${propertyContext}-${formattedPropertyName}`;
