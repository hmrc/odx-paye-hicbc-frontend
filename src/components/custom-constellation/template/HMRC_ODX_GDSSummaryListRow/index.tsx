...
import StyledHmrcOdxGdsSummaryListRowWrapper from './styles';

// interface for props
interface HmrcOdxGdsSummaryListRowProps extends PConnFieldProps {
...
function HmrcOdxGdsSummaryListRow(props: HmrcOdxGdsSummaryListRowProps) {
  ...
  if (readOnly && readOnly === true || displayMode && displayMode === 'DISPLAY_ONLY') {
    ...
    return (
      <StyledHmrcOdxGdsSummaryListRowWrapper>
...
export default withConfiguration(HmrcOdxGdsSummaryListRow);
