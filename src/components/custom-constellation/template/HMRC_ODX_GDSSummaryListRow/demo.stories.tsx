...
import HmrcOdxGdsSummaryListRow from './index';
...
const meta: Meta<typeof HmrcOdxGdsSummaryListRow> = {
  title: 'HmrcOdxGdsSummaryListRow',
  component: HmrcOdxGdsSummaryListRow,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof HmrcOdxGdsSummaryListRow>;
...
export const BaseHmrcOdxGdsSummaryListRow: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <HmrcOdxGdsSummaryListRow {...props} {...args}>{regionAChildren}</HmrcOdxGdsSummaryListRow>
    </>
  );
};

BaseHmrcOdxGdsSummaryListRow.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1,
