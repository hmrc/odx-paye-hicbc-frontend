    ...
    <StyledHmrcOdxGdsTaskListTemplateWrapper>
      ...
      <div className='govuk-!-padding-bottom-4'>
        <p className='govuk-body govuk-!-font-weight-bold'>
          {completedSections < totalSections ? `${t('CLAIM')} ${t('INCOMPLETE')}` : `${t('CLAIM')} ${t('COMPLETE')}`}
        </p>
                  ...
                  <li className='govuk-task-list__item govuk-task-list__item--with-link'>
                    ...
                    {task.IsTaskALink &&
                      ...
                      !task.IsTaskComplete && ( // in progress
                        <div className='govuk-task-list__status' id={`${task.TaskLabel.replaceAll(' ', '')}-${key}-status`}>
                          <strong className='govuk-tag govuk-tag--light-blue'>{labelStatusMapping(task.TaskStatus)}</strong>
                        </div>
                      )}
