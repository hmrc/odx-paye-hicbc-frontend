...
import { registerNonEditableField, registerComplexQuestion } from '../../../helpers/hooks/QuestionDisplayHooks';
...
export default function HmrcOdxComplexQuestionExplanation(props: HmrcOdxComplexQuestionExplanationProps) {
  ...
  return <ParsedHTML htmlString={getFormattedInstructionText(value)} DOMSanitiseHooks={[addGovukBodyToParagraphHook]} />;
}
