            ...
            <Fragment key={key}>
              <li className='govuk-task-list__item govuk-task-list__item--with-link'>
                <div className='govuk-task-list__name-and-hint'>
                  {task.IsTaskALink ? (
                    <a className='govuk-link govuk-task-list__link' href='#' aria-describedby={`${task.TaskLabel.replaceAll(' ', '')}-${key}-status`}>
                      {task.TaskLabel}
                ...
                <div className='govuk-task-list__status' id={`${task.TaskLabel.replaceAll(' ', '')}-${key}-status`}>
                  {task.TaskStatus === 'In progress' ? <strong className='govuk-tag govuk-tag--blue'>{task.TaskStatus}</strong> : task.TaskStatus}
