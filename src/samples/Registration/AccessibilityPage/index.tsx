...
export default function Accessibility() {
  ...
  return (
    <>
      <h1 className='govuk-heading-xl'>{t('ACCESSIBLITY_STATEMENT_FOR_HICBC_SERVICE')}</h1>
      ...
      <p className='govuk-body'>
        {t('THIS_PAGE_CONTAINS_INFO_ABOUT_HICBC_SERVICE')}{' '}
        URL
      </p>

      <h2 className='govuk-heading-l'>{t('USING_THIS_SERVICE')}</h2>
      <p className='govuk-body'>
        {t('USE_THIS_FORM_TO_PAY')}
      </p>
      ...
      <p className='govuk-body'>
        ...
        <a
          className='govuk-link'
          href={`${hmrcURL}contact/accessibility?service=SCAHICBC&referrerUrl=${referrerURL}`}
          target='_blank'
          rel='noreferrer noopener'
        >
