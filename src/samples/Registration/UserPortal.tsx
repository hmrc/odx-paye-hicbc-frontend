...
export default function UserPortal(props) {
  ...
  return (
    <div className={isLogout ? 'govuk-main-wrapper visibility-hidden' : 'govuk-main-wrapper'} id='main-content-registration'>
      {showPortalBanner && <NotificationBanner content={t('SA_PORTAL_NOTIFICATION_BANNER_CONTENT')} />}
